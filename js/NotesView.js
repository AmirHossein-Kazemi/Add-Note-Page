...
<div class="note__small-updated">${new Date(updated).toLocaleString("us", {
      dateStyle: "full",
      timeStyle: "short",
    })}</div>
</div>
`;
  ...
  updateNotePreviewVisibility(visibale) {
    this.root.querySelector(".notes__preview").style.visibility = visibale
      ? "visibale"
      : "hidden";
  }
}
